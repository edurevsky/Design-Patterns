...
class Template_de_imposto_condicional(Imposto): # Design Pattern Template method
...
def IPVX(metodo_ou_funcao): # Design Pattern Decorator
    def wrapper(self, orcamento):
        return metodo_ou_funcao(self, orcamento) + 50.0
    return wrapper
    # Chama o calculo de um imposto e adiciona mais R$50
